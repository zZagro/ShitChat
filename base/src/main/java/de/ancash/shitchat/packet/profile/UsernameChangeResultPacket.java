...
public class UsernameChangeResultPacket extends SessionedPacket implements IProfilePacket {
	...
	public UsernameChangeResultPacket(UUID sessionId, User newUser, String reason) {
		super(sessionId);
